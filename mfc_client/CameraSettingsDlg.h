...
public:
	void CCameraSettingsDlg::OnTcnSelchangeTab1(NMHDR*, LRESULT* pRes) { *pRes = 0; }
	void CCameraSettingsDlg::OnTcnSelchangeTab2(NMHDR*, LRESULT* pRes) { *pRes = 0; }
	void CCameraSettingsDlg::OnNMClickTabSettings(NMHDR*, LRESULT* pRes) { *pRes = 0; }
	void CCameraSettingsDlg::OnCbnSelchangeComboTop() { /* no-op */ }

	BOOL m_bTopFlipH = FALSE;
	BOOL m_bTopFlipV = FALSE;
	BOOL m_bSideFlipH = FALSE;
	BOOL m_bSideFlipV = FALSE;
};