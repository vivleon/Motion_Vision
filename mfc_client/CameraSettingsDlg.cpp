...
void CCameraSettingsDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHECK_TOP_FLIP_H, m_bTopFlipH);
	DDX_Check(pDX, IDC_CHECK_TOP_FLIP_V, m_bTopFlipV);
	DDX_Check(pDX, IDC_CHECK_SIDE_FLIP_H, m_bSideFlipH);
	DDX_Check(pDX, IDC_CHECK_SIDE_FLIP_V, m_bSideFlipV);
