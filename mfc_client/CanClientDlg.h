...
private:
    ...
    void ConvertPylonBufferToMat(Pylon::CPylonImage& pylonImg,
        Pylon::CGrabResultPtr& grabResult, cv::Mat& outMat,
        const CString& role = _T(""));  // ← role 기본값 추가
    ...
    // Preview modeless dialog pointer
    CPreviewDlg* m_pPreviewDlg = nullptr;
